...
<div id="ppd" class="col-sm-6">
  ...
  <form id="personalDetails">
    ...
    <div class="form-group mb-4">
      ...
      <input type="email" class="form-control" id="exampleAccountEmail1" name="email" value="{{ session('email') }}">
    </div>
    ...
    <div class="form-group mb-3">
      ...
      <input type="password" class="form-control" id="exampleAccountConfirmPassword" placeholder="Confirm Password"
